    ...
    public partial class Profile : System.Web.UI.Page
    {
        ...
        protected void ButtonEndorce_Command(object sender, CommandEventArgs e)
        {
            ...
            try
            {
                ...
                if (targetUser.UserName != currentUser.UserName)
                {
                    ...
                    {
                        targetUser.Skills.FirstOrDefault(s => s.Name == skillName).Votes.Add(new Vote() { User = currentUser });
                        context.SaveChanges();
                        this.DataBind();
                        ErrorSuccessNotifier.AddSuccessMessage("Skill endorsed successfully!");
                    }
                    else
                    {
                        ErrorSuccessNotifier.AddInfoMessage("You have already endorsed this skill!");
                    }
                }

                else
                {
                    ErrorSuccessNotifier.AddInfoMessage("You cannot endorse own skills");
                }
            }
            catch (Exception ex)
            {
        ...
        protected void ButtonAddSkill_Command(object sender, CommandEventArgs e)
        {
            ...
            try
            {
                ...
                skillName = TextBoxSkillName.Text.ToString();
                if (!String.IsNullOrEmpty(skillName))
                {
                    ...
                    ErrorSuccessNotifier.AddSuccessMessage("Skill added");
                }
            }
            catch (Exception ex)
            {
